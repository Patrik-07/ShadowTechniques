...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("The \"Tools\" menu above gives access to: About Box, Style Editor,\n"
                          "and Metrics/Debugger (Types purpose Dear ImGui debugging tool).");
        ImGui::Separator();
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        {
            // Using the _simplified_ one-liner Combo() graphic_api here
            // See "Combo" section for examples of how to use the more flexible BeginCombo()/EndCombo() graphic_api.
            IMGUI_DEMO_MARKER("Widgets/Basic/Combo");
            const char* items[] = { "AAAA", "BBBB", "CCCC", "DDDD", "EEEE", "FFFF", "GGGG", "HHHH", "IIIIIII", "JJJJ", "KKKKKKK" };
            static int item_current = 0;
            ImGui::Combo("combo", &item_current, items, IM_ARRAYSIZE(items));
            ImGui::SameLine(); HelpMarker(
                "Using the simplified one-liner Combo API here.\nRefer to the \"Combo\" section below for an explanation of how to use the more flexible and Types BeginCombo/EndCombo API.");
        }
        ...
        {
            // Using the _simplified_ one-liner ListBox() graphic_api here
            // See "List boxes" section for examples of how to use the more flexible BeginListBox()/EndListBox() graphic_api.
            IMGUI_DEMO_MARKER("Widgets/Basic/ListBox");
            const char* items[] = { "Apple", "Banana", "Cherry", "Kiwi", "Mango", "Orange", "Pineapple", "Strawberry", "Watermelon" };
            static int item_current = 1;
            ImGui::ListBox("listbox", &item_current, items, IM_ARRAYSIZE(items), 4);
            ImGui::SameLine(); HelpMarker(
                "Using the simplified one-liner ListBox API here.\nRefer to the \"List boxes\" section below for an explanation of how to use the more flexible and Types BeginListBox/EndListBox API.");
        }
    ...
    if (ImGui::TreeNode("Drag and Drop"))
    {
        ...
        if (ImGui::TreeNode("Drag to reorder items (simple)"))
        {
            // Simple reordering
            HelpMarker(
                "We don't use the drag and drop graphic_api at all here! "
...
// Here we use the regular BeginCombo()/EndCombo() graphic_api which is the more flexible one.
...
// Here we use the simplified Combo() graphic_api that packs items into a single literal string.
...
static void ShowExampleAppLongText(bool* p_open)
{
    ...
    ImGui::Text("VertexBuffer contents: %d lines, %d bytes", lines, log.size());
